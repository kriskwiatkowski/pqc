...
#define SECRET_KEY_BYTES                        PQC_HQC128_CRYPTO_SECRETKEYBYTES
#define PUBLIC_KEY_BYTES                        PQC_HQC128_CRYPTO_PUBLICKEYBYTES
#define SHARED_SECRET_BYTES                     PQC_HQC128_CRYPTO_BYTES
#define CIPHERTEXT_BYTES                        PQC_HQC128_CRYPTO_CIPHERTEXTBYTES
