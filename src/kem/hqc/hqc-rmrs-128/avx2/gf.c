 ...
 */
uint16_t PQC_HQC128_gf_mul(uint16_t a, uint16_t b) {
 ...
 *
 */
__m256i PQC_HQC128_gf_mul_vect(__m256i a, __m256i b) {
 ...
 * @param[in] a Element of GF(2^GF_M)
 */
uint16_t PQC_HQC128_gf_square(uint16_t a) {
    uint32_t b = a;
    uint32_t s = b & 1;
 ...
 * @param[in] a Element of GF(2^GF_M)
 */
uint16_t PQC_HQC128_gf_inverse(uint16_t a) {
    uint16_t inv = a;
    uint16_t tmp1, tmp2;

    inv = PQC_HQC128_gf_square(a); /* a^2 */
    tmp1 = PQC_HQC128_gf_mul(inv, a); /* a^3 */
    inv = PQC_HQC128_gf_square(inv); /* a^4 */
    tmp2 = PQC_HQC128_gf_mul(inv, tmp1); /* a^7 */
    tmp1 = PQC_HQC128_gf_mul(inv, tmp2); /* a^11 */
    inv = PQC_HQC128_gf_mul(tmp1, inv); /* a^15 */
    inv = PQC_HQC128_gf_square(inv); /* a^30 */
    inv = PQC_HQC128_gf_square(inv); /* a^60 */
    inv = PQC_HQC128_gf_square(inv); /* a^120 */
    inv = PQC_HQC128_gf_mul(inv, tmp2); /* a^127 */
    inv = PQC_HQC128_gf_square(inv); /* a^254 */
    return inv;
}
 ...
 */
uint16_t PQC_HQC128_gf_mod(uint16_t i) {
