...
#define SECRET_KEY_BYTES                        PQC_HQC256_CRYPTO_SECRETKEYBYTES
#define PUBLIC_KEY_BYTES                        PQC_HQC256_CRYPTO_PUBLICKEYBYTES
#define SHARED_SECRET_BYTES                     PQC_HQC256_CRYPTO_BYTES
#define CIPHERTEXT_BYTES                        PQC_HQC256_CRYPTO_CIPHERTEXTBYTES
